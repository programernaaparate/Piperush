...
const difficultyBlueprints = {
  easy: [
    ...
    },
    {
      id: "easy-6f",
      name: "Ulazni Raster",
      briefing: "Podigni tok kroz lijevi uspon, presijeci gornji raster i zatvori desni izlaz bez lutanja.",
      difficulty: "easy",
      scrambleProfileIndex: 6,
      gridSize: 5,
      timeLimit: 88,
      ...
      extras: [
        extra([0, 1], "dead-end", 180),
        extra([1, 1], "valve", 90),
        extra([1, 3], "corner", 180),
        extra([3, 3], "t", 180),
        extra([4, 1], "straight", 0),
      ],
    },
    {
      id: "easy-6g",
      name: "Kontrolna Petlja",
      briefing: "Spusti tok kroz servisni stub, okreni ga preko petlje i zakljucaj gornji izlaz prije pada pritiska.",
      difficulty: "easy",
      scrambleProfileIndex: 6,
      gridSize: 5,
      timeLimit: 84,
    ...
    },
    {
      ...
      difficulty: "easy",
      isBoss: true,
      background: "/assets/backgrounds/bg-aegis-reactor-frame.svg",
      gridSize: 5,
      timeLimit: 104,
      hints: 1,
      moveTarget: 14,
  ...
  medium: [
    ...
    },
    {
      id: "medium-6f",
      name: "Rotorni Most",
      briefing: "Podigni tok uz lijevi zid, provuci ga preko srednjeg mosta i zatvori donji desni izlaz bez viska poteza.",
      difficulty: "medium",
      scrambleProfileIndex: 6,
      gridSize: 6,
      timeLimit: 68,
    ...
    {
      id: "medium-6g",
      name: "Komandni Bypass",
      briefing: "Prebaci impuls kroz donju magistralu, presijeci komandni krak i vrati tok u desni izlaz prije nego sto mreza pukne.",
      difficulty: "medium",
      scrambleProfileIndex: 6,
      gridSize: 6,
      timeLimit: 64,
      ...
      extras: [
        extra([0, 1], "valve", 90),
        extra([1, 2], "corner", 0),
        extra([1, 5], "dead-end", 180),
        extra([3, 1], "t", 90),
        extra([3, 3], "cross"),
        extra([5, 2], "straight", 0),
        extra([5, 4], "corner", 270),
      ],
      specials: [
        special([2, 4], {
    ...
    },
    {
      ...
      difficulty: "medium",
      isBoss: true,
      background: "/assets/backgrounds/bg-gyro-reactor-frame.svg",
      gridSize: 6,
      timeLimit: 84,
      hints: 1,
      moveTarget: 18,
  ...
  hard: [
    ...
    },
    {
      id: "hard-6e",
      name: "Fazni Tunel",
      briefing: "Spusti impuls iz gornjeg desnog ulaza, slomi ga kroz jezgro i provuci ga do donjeg lijevog kolektora bez praznog hoda.",
      difficulty: "hard",
      scrambleProfileIndex: 7,
      gridSize: 7,
      timeLimit: 60,
    ...
    },
    {
      id: "hard-6f",
      name: "Kriticni Most",
      briefing: "Izvuci tok kroz donji prsten, premosti centralni lom i zakljucaj gornji izlaz prije potpunog kolapsa.",
      difficulty: "hard",
      scrambleProfileIndex: 7,
      gridSize: 7,
      timeLimit: 58,
    ...
    },
    {
      ...
      scrambleProfileIndex: 7,
      isBoss: true,
      background: "/assets/backgrounds/bg-warden-reactor-frame.svg",
      gridSize: 7,
      timeLimit: 56,
      hints: 0,
      moveTarget: 25,
      ...
      bossProfile: {
        ...
        phaseLabel: "Analiza zaključavanja",
      },
    },
    {
      id: "hard-8",
